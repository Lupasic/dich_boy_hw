...
this.def["dichboy_full_B"] = {file: "dichboy_full_c.html",line:24,type:"var"};
this.def["dichboy_full_DW"] = {file: "dichboy_full_c.html",line:27,type:"var"};
this.def["dichboy_full_M_"] = {file: "dichboy_full_c.html",line:30,type:"var"};
this.def["dichboy_full_M"] = {file: "dichboy_full_c.html",line:31,type:"var"};
this.def["dichboy_full_step"] = {file: "dichboy_full_c.html",line:34,type:"fcn"};
this.def["dichboy_full_initialize"] = {file: "dichboy_full_c.html",line:252,type:"fcn"};
this.def["dichboy_full_terminate"] = {file: "dichboy_full_c.html",line:316,type:"fcn"};
this.def["B_dichboy_full_T"] = {file: "dichboy_full_h.html",line:51,type:"type"};
this.def["DW_dichboy_full_T"] = {file: "dichboy_full_h.html",line:62,type:"type"};
this.def["Ctl"] = {file: "dichboy_full_types_h.html",line:28,type:"type"};
this.def["P_dichboy_full_T"] = {file: "dichboy_full_types_h.html",line:33,type:"type"};
this.def["RT_MODEL_dichboy_full_T"] = {file: "dichboy_full_types_h.html",line:36,type:"type"};
this.def["dichboy_full_P"] = {file: "dichboy_full_data_c.html",line:24,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["dichboy_full_c.html"] = "../dichboy_full.c";
	this.html2Root["dichboy_full_c.html"] = "dichboy_full_c.html";
	this.html2SrcPath["dichboy_full_h.html"] = "../dichboy_full.h";
	this.html2Root["dichboy_full_h.html"] = "dichboy_full_h.html";
	this.html2SrcPath["dichboy_full_private_h.html"] = "../dichboy_full_private.h";
	this.html2Root["dichboy_full_private_h.html"] = "dichboy_full_private_h.html";
	this.html2SrcPath["dichboy_full_types_h.html"] = "../dichboy_full_types.h";
	this.html2Root["dichboy_full_types_h.html"] = "dichboy_full_types_h.html";
	this.html2SrcPath["dichboy_full_data_c.html"] = "../dichboy_full_data.c";
	this.html2Root["dichboy_full_data_c.html"] = "dichboy_full_data_c.html";
...
var fileList = [
"ert_main_c.html","dichboy_full_c.html","dichboy_full_h.html","dichboy_full_private_h.html","dichboy_full_types_h.html","dichboy_full_data_c.html","rtwtypes_h.html","rtmodel_h.html","MW_custom_RTOS_header_h.html","MW_target_hardware_resources_h.html"];
